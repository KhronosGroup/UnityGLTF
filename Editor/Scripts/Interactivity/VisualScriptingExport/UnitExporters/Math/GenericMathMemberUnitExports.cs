...
namespace UnityGLTF.Interactivity.VisualScripting.Export
{
    public static class GenericGetMemberMathExportersRegister
    {
        ...
        public static void Register()
        {
            ...
            GetMemberUnitExport.RegisterMemberExporter(typeof(Vector2), nameof(Vector2.magnitude), new GenericGetMemberMathExporters<Math_LenghNode>());
            GetMemberUnitExport.RegisterMemberExporter(typeof(Vector3), nameof(Vector3.magnitude), new GenericGetMemberMathExporters<Math_LenghNode>());
            GetMemberUnitExport.RegisterMemberExporter(typeof(Vector4), nameof(Vector3.magnitude), new GenericGetMemberMathExporters<Math_LenghNode>());
