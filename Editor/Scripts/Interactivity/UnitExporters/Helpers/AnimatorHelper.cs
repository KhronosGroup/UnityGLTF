...
namespace UnityGLTF.Interactivity.Export
{
    public static class AnimatorHelper
    {
        ...
        public static  int GetAnimationId(AnimatorState state, GltfInteractivityExportContext exportContext)
        {
            string animationName = state.motion.name;
            return GltfInteractivityNodeHelper.GetNamedPropertyGltfIndex(animationName,
