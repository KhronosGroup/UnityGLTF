...
namespace Editor.UnitExporters.Lists
{
    public static class ListHelpers
    {
        ...
        public static void InsertItem(UnitExporter unitExporter, GltfInteractivityExportContext.VariableBasedList list,
        ...
        public static void RemoveListItemAt(UnitExporter unitExporter, GltfInteractivityExportContext.VariableBasedList list,
