...
namespace UnityGLTF
{
	...
	{
		/// <summary>
		/// Turns a glTF file w/ structure into a GLB. 
		/// </summary>
		...
		public static async Task<GLBObject> ConstructFromGLTF(GLTFRoot root, Stream glbOutStream, Func<string, Stream> loader)
		{
		...
		private static void _UpdateStream(GLBObject glb, Stream outStream)
		{
			...
			using (StreamWriter sw = new StreamWriter(gltfJsonStream))
			{
				...
				if (glb.JsonChunkInfo.Length < gltfJsonStream.Length)
				{
					...
					amountToAddToFile = proposedJsonChunkLength - glb.JsonChunkInfo.Length;
		...
		public static Task<GLTFId<BufferView>> AddBlob(GLBObject glb, Stream blob)
		{
			throw new NotImplementedException();
		}
		...
		/// <returns>The location of the added buffer view</returns>
		public static Task<GLTFId<BufferView>> AddBlob(GLBObject mergeTo, GLBObject mergeFrom)
		{
			throw new NotImplementedException();
		}
		...
		/// <param name="bufferView">The buffer to remove</param>
		public static Task RemoveBlob(GLBObject glb, GLTFId<BufferView> bufferView)
		{
			throw new NotImplementedException();
		}
		...
		public static Task RemoveBlob(GLBObject glb, GLTFId<Node> bufferView)
		{
			throw new NotImplementedException();
		}
