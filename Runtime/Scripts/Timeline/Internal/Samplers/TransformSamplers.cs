...
namespace UnityGLTF.Timeline.Samplers
{
    internal class TranslationSampler : AnimationSampler<Transform, Vector3>
    {
        ...
        public override AnimationTrack StartNewAnimationTrackAt(AnimationData data, double time) => new AnimationTrack<Transform, Vector3>(data, this, time);
    ...
    internal class RotationSampler : AnimationSampler<Transform, Quaternion>
    {
        ...
        public override AnimationTrack StartNewAnimationTrackAt(AnimationData data, double time) => new AnimationTrack<Transform, Quaternion>(data, this, time);
        protected override Transform getTarget(Transform transform) => transform;
