...
#if UNITY_6000_1_OR_NEWER // ReadOnlySpan support was added to LoadImage in Unity 6.1+, but we still need to call ToArray() for older versions, so we can't use it in the whole method yet.
