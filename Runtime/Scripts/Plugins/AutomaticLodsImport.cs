...
namespace UnityGLTF.Plugins
{
    ...
    {
        public override string DisplayName => "Automatic LODs";
        public override string Description => "Automatically generate LOD Groups when child GameObjects with name 'LOD...' are found.";
