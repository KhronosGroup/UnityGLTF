...
namespace UnityGLTF.Interactivity.Playback
{
    public static class NodeRegistry
    {
        ...
        private static readonly Dictionary<string, Func<BehaviourEngine, Node, BehaviourEngineNode>> nodeTypes = new()
        {
            ...
            ["math/quatConjugate"] = (engine, node) => new MathQuatConjugate(engine, node),
            ["math/quatMul"] = (engine, node) => new MathQuatMul(engine, node),
            ["math/quatAngleBetween"] = (engine, node) => new MathQuatAngleBetween(engine, node),
            ["math/quatFromAxisAngle"] = (engine, node) => new MathQuatFromAxisAngle(engine, node),
            ["math/quatToAxisAngle"] = (engine, node) => new MathQuatToAxisAngle(engine, node),
            ["math/quatFromDirections"] = (engine, node) => new MathQuatFromDirections(engine, node),
            ["math/quatFromUpForward"] = (engine, node) => new MathQuatFromUpForward(engine, node),
            ["math/quatSlerp"] = (engine, node) => new MathQuatSlerp(engine, node),
        ...
        public static readonly Dictionary<string, NodeSpecifications> nodeSpecs = new()
        {
            ...
            ["math/quatConjugate"] = new MathQuatConjugateSpec(),
            ["math/quatMul"] = new MathQuatMulSpec(),
            ["math/quatAngleBetween"] = new MathQuatAngleBetweenSpec(),
            ["math/quatFromAxisAngle"] = new MathQuatFromAxisAngleSpec(),
            ["math/quatToAxisAngle"] = new MathQuatToAxisAngleSpec(),
            ["math/quatFromDirections"] = new MathQuatFromDirectionsSpec(),
            ["math/quatSlerp"] = new MathQuatSlerpSpec(),
            ...
            ["math/quatFromUpForward"] = new MathQuatFromUpForwardSpec(),
