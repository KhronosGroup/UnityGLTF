...
namespace GLTFSerializerTests
{
    ...
    public class GLTFLoaderTest
    {
        ...
        private void TestAccessor(Accessor accessor, GLTFAccessorAttributeType type, int count, GLTFComponentType componentType, int bufferViewId, List<float> max, List<float> min)
        {
        ...
        private void TestAccessors(GLTFRoot gltfRoot)
        {
        ...
        private void TestGLBAccessors(GLTFRoot gltfRoot)
        {
            List<Accessor> accessors = gltfRoot.Accessors;
            Assert.AreEqual(5, accessors.Count);
        ...
        private void TestAssetData(GLTFRoot gltfRoot)
        {
            Assert.AreEqual("2.0", gltfRoot.Asset.Version);
            Assert.AreEqual("glTF Tools for Unity", gltfRoot.Asset.Generator);
        }

        private void TestBufferView(BufferView bufferView, int buffer, int byteOffset, int byteLenth)
        {
        ...
        private void TestBufferViews(GLTFRoot gltfRoot)
        {
        ...
        private void TestGLBBufferViews(GLTFRoot gltfRoot)
        {
            List<BufferView> bufferViews = gltfRoot.BufferViews;
        ...
        private void TestBuffers(GLTFRoot gltfRoot)
        {
        ...
        private void TestGLBBuffers(GLTFRoot gltfRoot)
        {
            List<Buffer> buffers = gltfRoot.Buffers;
            Assert.AreEqual(1, buffers.Count);
        ...
        private void TestImages(GLTFRoot gltfRoot)
        {
        ...
        private void TestGLBImages(GLTFRoot gltfRoot)
        {
            List<Image> images = gltfRoot.Images;
            Assert.AreEqual(4, images.Count);
        ...
        private void TestMeshes(GLTFRoot gltfRoot)
        {
        ...
        private void TestMaterials(GLTFRoot gltfRoot)
        {
        ...
        private void TestNodes(GLTFRoot gltfRoot)
        {
        ...
        private void TestScenes(GLTFRoot gltfRoot)
        {
        ...
        private void TestTextures(GLTFRoot gltfRoot)
        {
        ...
        private void TestGLTF(GLTFRoot gltfRoot)
        {
        ...
        private void TestGLB(GLTFRoot gltfRoot)
        {
